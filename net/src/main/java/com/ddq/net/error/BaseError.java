...
import static com.ddq.net.error.ErrorState.BUSINESS_ERROR;
import static com.ddq.net.error.ErrorState.DEFAULT_ERROR;
import static com.ddq.net.error.ErrorState.NO_DATA;
import static com.ddq.net.error.ErrorState.SESSION_TIME_OUT;
import static com.ddq.net.error.ErrorState.getMsg;
